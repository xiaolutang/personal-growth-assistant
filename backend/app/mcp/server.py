...
async def call_tool(name: str, arguments: Any) -> list[TextContent]:
    ...
    try:
        if name == "list_entries":
            return await handle_list_entries(arguments)
        elif name == "get_entry":
            return await handle_get_entry(arguments)
        elif name == "create_entry":
            return await handle_create_entry(arguments)
        elif name == "update_entry":
            return await handle_update_entry(arguments)
        elif name == "delete_entry":
            return await handle_delete_entry(arguments)
        elif name == "search_entries":
            return await handle_search_entries(arguments)
        elif name == "get_knowledge_graph":
            return await handle_get_knowledge_graph(arguments)
        elif name == "get_related_concepts":
            return await handle_get_related_concepts(arguments)
        elif name == "get_project_progress":
            return await handle_get_project_progress(arguments)
        else:
...
async def handle_list_entries(args: dict) -> list[TextContent]:
    """处理 list_entries"""
...
async def handle_get_entry(args: dict) -> list[TextContent]:
    """处理 get_entry"""
    entry_id = args["id"]
...
async def handle_create_entry(args: dict) -> list[TextContent]:
    """处理 create_entry"""
...
async def handle_update_entry(args: dict) -> list[TextContent]:
    """处理 update_entry"""
    entry_id = args["id"]
    entry = storage.markdown.read_entry(entry_id)
...
async def handle_delete_entry(args: dict) -> list[TextContent]:
    """处理 delete_entry"""
    entry_id = args["id"]
...
async def handle_search_entries(args: dict) -> list[TextContent]:
    """处理 search_entries"""
    query = args["query"]
...
async def handle_get_knowledge_graph(args: dict) -> list[TextContent]:
...
async def handle_get_related_concepts(args: dict) -> list[TextContent]:
...
async def handle_get_project_progress(args: dict) -> list[TextContent]:
