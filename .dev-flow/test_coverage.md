...
| 快捷建议+页面状态同步 | F39 | unit+manual | 各page_type建议正确/点击填入/消息>0隐藏/chatStore.pageExtra读写/Explore tab/query同步/FloatingChat合并extra/离开Explore清空extra/build+test通过 | covered | 231 frontend tests + build pass |
