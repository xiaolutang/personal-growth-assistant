...
| 探索页创建 | F04 | unit+F2+integration | inbox/reflection/question tab +New 创建/搜索结果态不显示 +New/note tab 无 +New/全部 tab 无 +New/创建后列表刷新/网络失败错误提示可重试 | done | 18 tests (Explore.F04) + 2 integration tests (Explore.F04.integration), 820/820 suite pass |
