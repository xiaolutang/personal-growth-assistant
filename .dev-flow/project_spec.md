...
1. **F172 api_client.dart 条目交互 API**：补齐 7 个 API 方法（updateEntry/fetchBacklinks/fetchEntryLinks/createEntryLink/deleteEntryLink/fetchKnowledgeContext/generateAISummary）+ 单元测试
2. **F173 entry_detail_provider.dart 扩展**：family provider 按 entryId 隔离状态 + 编辑/保存/AI摘要/关联操作/反向引用加载/关联搜索 + Provider 测试
