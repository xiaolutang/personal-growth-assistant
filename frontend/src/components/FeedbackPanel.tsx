/**
 * FeedbackPanel.tsx — 反馈表单面板（提交反馈 + 我的反馈）
 *
 * 从 FeedbackButton 提取的独立表单组件，用于嵌入到聊天面板的 Popover 中。
 * 不包含浮动按钮逻辑，仅负责表单 UI 和 API 交互。
 */
...
interface FeedbackPanelProps {
  /** Popover 打开状态变化时触发重置等操作 */
  isOpen?: boolean;
}

export function FeedbackPanel({ isOpen }: FeedbackPanelProps) {
